      ...
      return SliverStickyHeader(
        header: ColoredBox(
          ...
          child: ListTile(
            title: Row(
              children: [
                if (dateSplitMenus.date.isToday()) Text(intl(context).today, style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.blue.shade600, fontWeight: FontWeight.bold)),
                if (dateSplitMenus.date.isTomorrow()) Text(intl(context).tomorrow, style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.blue.shade300, fontWeight: FontWeight.bold)),
                if (dateSplitMenus.date.isDayAfterTomorrow()) Text(intl(context).dayAfterTomorrow, style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.blue.shade200, fontWeight: FontWeight.bold)),
                ...
                Text(dateSplitMenus.date.toDateString(context), style: Theme.of(context).textTheme.titleMedium),
              ],
            ),
          ),
        ),
