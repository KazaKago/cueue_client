...
class UpdateMenuApi {
  ...
  Future<MenuResponse> execute(final int menuId, final MenuRequest request) async {
    try {
      final response = await _requester.create().patch<Map<String, dynamic>>('/menus/$menuId', data: request);
