...
class TagRepositoryImpl implements TagRepository {
  const TagRepositoryImpl(this._getTagsApi, this._createTagApi, this._updateTagApi, this._deleteTagApi, this._getRecipeApi, this._tagResponseMapper, this._tagRequestMapper, this._recipeResponseMapper);
  ...
  LoadingStateStream<List<Tag>> follow() {
    final tagFlowable = TagFlowableFactory(_getTagsApi, _tagResponseMapper).create();
