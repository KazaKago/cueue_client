...
final authorizeRepositoryProvider = Provider<AuthorizeRepository>((ref) => AuthorizeRepositoryImpl(ref.read(userResponseMapperProvider), ref.read(passwordSignaturerProvider), ref.read(googleSignaturerProvider), ref.read(appleSignaturerProvider)));
...
final userRepositoryProvider = Provider<UserRepository>((ref) => UserRepositoryImpl(ref.read(userResponseMapperProvider), ref.read(createUserApiProvider), ref.read(passwordSignaturerProvider)));
final tagRepositoryProvider = Provider<TagRepository>((ref) => TagRepositoryImpl(ref.read(getTagsApiProvider), ref.read(createTagApiProvider), ref.read(updateTagApiProvider), ref.read(deleteTagApiProvider), ref.read(getRecipeApiProvider), ref.read(tagResponseMapperProvider), ref.read(tagRequestMapperProvider), ref.read(recipeResponseMapperProvider)));
final recipeRepositoryProvider = Provider<RecipeRepository>((ref) => RecipeRepositoryImpl(ref.read(getRecipesApiProvider), ref.read(getRecipeApiProvider), ref.read(createRecipeApiProvider), ref.read(updateRecipeApiProvider), ref.read(deleteRecipeApiProvider), ref.read(getMenuApiProvider), ref.read(getMenusApiProvider), ref.read(recipeResponseMapperProvider), ref.read(recipeSummaryResponseMapperProvider), ref.read(recipeRequestMapperProvider), ref.read(menuSummaryResponseMapperProvider), ref.read(menuResponseMapperProvider)));
final menuRepositoryProvider = Provider<MenuRepository>((ref) => MenuRepositoryImpl(ref.read(getMenuApiProvider), ref.read(getMenusApiProvider), ref.read(createMenuApiProvider), ref.read(updateMenuApiProvider), ref.read(deleteMenuApiProvider), ref.read(menuSummaryResponseMapperProvider), ref.read(menuResponseMapperProvider), ref.read(menuRequestMapperProvider)));
