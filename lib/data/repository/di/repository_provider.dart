...
import 'package:cueue/data/repository/hierarchy/info/app_info_repository_impl.dart';
...
final infoRepositoryProvider = Provider<AppInfoRepository>((ref) => AppInfoRepositoryImpl(ref.read(appInfoConstantsProvider)));
...
final invitationRepositoryProvider = Provider<InvitationRepository>((ref) => InvitationRepositoryImpl(ref.read(getInvitationApiProvider), ref.read(createInvitationApiProvider), ref.read(acceptInvitationApiProvider), ref.read(invitationResponseMapperProvider), ref.read(allCacheProvider)));
