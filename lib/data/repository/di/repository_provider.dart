...
final userRepositoryProvider = Provider<UserRepository>((ref) => UserRepositoryImpl(ref.read(allCacheProvider), ref.read(createUserApiProvider), ref.read(createContentApiProvider), ref.read(userFlowableFactoryProvider), ref.read(userResponseMapperProvider), ref.read(contentRequestMapperProvider)));
final tagRepositoryProvider = Provider<TagRepository>((ref) => TagRepositoryImpl(ref.read(recipeCacheProvider), ref.read(createTagApiProvider), ref.read(updateTagApiProvider), ref.read(deleteTagApiProvider), ref.read(orderTagApiProvider), ref.read(tagResponseMapperProvider), ref.read(tagRequestMapperProvider), ref.read(tagOrderRequestMapperProvider), ref.read(tagFlowableFactoryProvider), ref.read(userFlowableFactoryProvider), ref.read(recipeFlowableFactoryProvider)));
final recipeRepositoryProvider = Provider<RecipeRepository>((ref) => RecipeRepositoryImpl(ref.read(recipeCacheProvider), ref.read(menuCacheProvider), ref.read(createRecipeApiProvider), ref.read(updateRecipeApiProvider), ref.read(deleteRecipeApiProvider), ref.read(recipeResponseMapperProvider), ref.read(recipeRequestMapperProvider), ref.read(recipesFlowableFactoryProvider), ref.read(recipeFlowableFactoryProvider), ref.read(userFlowableFactoryProvider), ref.read(menuFlowableFactoryProvider), ref.read(menuSummaryFlowableFactoryProvider)));
...
final workspaceRepositoryProvider = Provider<WorkspaceRepository>((ref) => WorkspaceRepositoryImpl(ref.read(createWorkspaceApiProvider), ref.read(userFlowableFactoryProvider), ref.read(workspaceResponseMapperProvider)));
...
final recipesFlowableFactoryProvider = Provider<RecipesFlowableFactory>((ref) => RecipesFlowableFactory(ref.read(recipeCacheProvider), ref.read(recipesStateManagerProvider), ref.read(getRecipesApiProvider), ref.read(recipeSummaryResponseMapperProvider), ref.read(userFlowableFactoryProvider)));
