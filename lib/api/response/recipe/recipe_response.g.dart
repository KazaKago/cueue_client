...
_$_RecipeResponse _$$_RecipeResponseFromJson(Map<String, dynamic> json) => _$_RecipeResponse(
      ...
      images: (json['images'] as List<dynamic>).map((e) => ContentResponse.fromJson(e as Map<String, dynamic>)).toList(),
      tags: (json['tags'] as List<dynamic>).map((e) => TagResponse.fromJson(e as Map<String, dynamic>)).toList(),
      cookingHistories: (json['cooking_histories'] as List<dynamic>).map((e) => e as String).toList(),
