  ...
  Widget _buildCompleted(Invitation invitation) {
    ...
    return Scrollbar(
      ...
      child: ListView(
        ...
        children: [
          SelectableText(textAlign: TextAlign.center, intl(useContext()).invitationCodePublishedTitle),
          ...
          SelectableText(textAlign: TextAlign.center, intl(useContext()).invitationCodePublishedMessage),
          const SizedBox(height: 32),
