...
extension ExceptionExtension on Exception {
  R when<R>({
    ...
    required R Function(EmailValidationException exception) invalidEmail,
    required R Function(PasswordValidationException exception) invalidPassword,
    required R Function(DoNotMatchPasswordException exception) doNotMatchPassword,
    required R Function(RequireReauthenticationException exception) reauthenticateRequired,
    required R Function(WrongPasswordException exception) wrongPassword,
    ...
    required R Function(EmailAlreadyInUseException exception) emailAlreadyInUse,
