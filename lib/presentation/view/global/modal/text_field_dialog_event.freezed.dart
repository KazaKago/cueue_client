...
abstract class _Positive implements TextFieldDialogEvent {
  const factory _Positive(String currentText, {String? originalText}) =
      _$_Positive;
...
abstract class _Neutral implements TextFieldDialogEvent {
  const factory _Neutral(String currentText, {String? originalText}) =
      _$_Neutral;
...
abstract class _Negative implements TextFieldDialogEvent {
  const factory _Negative(String currentText, {String? originalText}) =
      _$_Negative;
