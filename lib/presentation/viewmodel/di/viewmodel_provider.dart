...
import 'package:cueue/presentation/viewmodel/hierarchy/invitation/invitation_creation_viewmodel.dart';
...
final aboutViewModelProvider = ChangeNotifierProvider.autoDispose((ref) => AboutViewModel(ref.read(getAppInfoUseCaseProvider)));
...
final workspaceCreationViewModelProvider = ChangeNotifierProvider.autoDispose((ref) => WorkspaceCreationViewModel(ref.read(getUserUseCaseProvider), ref.read(createWorkspaceUseCaseProvider)));
