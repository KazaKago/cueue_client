...
final recipeViewModelProvider = ChangeNotifierProvider.autoDispose.family<RecipeViewModel, TagId?>((ref, tagId) => RecipeViewModel(ref.read(followAllRecipesUseCaseProvider), ref.read(followTaggedRecipesUseCaseProvider), ref.read(refreshAllRecipesUseCaseProvider), ref.read(refreshTaggedRecipesUseCaseProvider), ref.read(requestAdditionalAllRecipesUseCaseProvider), ref.read(requestAdditionalTaggedRecipesUseCaseProvider), tagId));
...
final tagViewModelProvider = ChangeNotifierProvider.autoDispose((ref) => TagViewModel(ref.read(followTagsUseCaseProvider), ref.read(refreshTagsUseCaseProvider)));
