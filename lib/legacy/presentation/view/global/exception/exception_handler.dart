...
class ExceptionHandler {
  ...
  Future<void> _goStore(BuildContext context, WidgetRef ref) async {
    ...
    final appInfoConstants = AppInfoConstants();
    final appInfo = AppInfo(
      appName: packageInfo.appName,
      version: packageInfo.version,
      webSite: Uri.parse(appInfoConstants.webSite),
      storeLink: Uri.parse(appInfoConstants.storeLink),
      developer: appInfoConstants.developer,
      email: Email(appInfoConstants.email),
    );
