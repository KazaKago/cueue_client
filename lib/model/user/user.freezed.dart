...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserId id, String displayName, Content? photo, GoogleProvider? googleProvider, AppleProvider? appleProvider, Workspace? workspace});
...
class _$_User extends _User {
  const _$_User({required this.id, required this.displayName, required this.photo, required this.googleProvider, required this.appleProvider, required this.workspace}) : super._();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other.runtimeType == runtimeType && other is _$_User && (identical(other.id, id) || other.id == id) && (identical(other.displayName, displayName) || other.displayName == displayName) && (identical(other.photo, photo) || other.photo == photo) && (identical(other.googleProvider, googleProvider) || other.googleProvider == googleProvider) && (identical(other.appleProvider, appleProvider) || other.appleProvider == appleProvider) && (identical(other.workspace, workspace) || other.workspace == workspace));
  }

  @override
  int get hashCode => Object.hash(runtimeType, id, displayName, photo, googleProvider, appleProvider, workspace);
...
abstract class _User extends User {
  const factory _User({required final UserId id, required final String displayName, required final Content? photo, required final GoogleProvider? googleProvider, required final AppleProvider? appleProvider, required final Workspace? workspace}) = _$_User;
