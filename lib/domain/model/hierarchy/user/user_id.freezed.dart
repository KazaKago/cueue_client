...
abstract class _$UserIdCopyWith<$Res> implements $UserIdCopyWith<$Res> {
  factory _$UserIdCopyWith(_UserId value, $Res Function(_UserId) then) = __$UserIdCopyWithImpl<$Res>;
  @override
  $Res call({String value});
}

/// @nodoc
class __$UserIdCopyWithImpl<$Res> extends _$UserIdCopyWithImpl<$Res> implements _$UserIdCopyWith<$Res> {
  __$UserIdCopyWithImpl(_UserId _value, $Res Function(_UserId) _then) : super(_value, (v) => _then(v as _UserId));
...
class _$_UserId implements _UserId {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other.runtimeType == runtimeType && other is _UserId && const DeepCollectionEquality().equals(other.value, value));
  }
